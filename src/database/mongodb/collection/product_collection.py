...
collection: Collection[ProductCollectionSchema] = mongo_client.product
...
def get_product_by_id(product_id: str) -> Optional[ProductModel]:
    try:
        ...
        return ProductModel(**snake_to_camel_case(product))
    except Exception as e:
        raise e


def update_product(product_id: str, updated_product: ProductCollectionSchema) -> bool:
    try:
        updated_product['_id'] = ObjectId(product_id)
